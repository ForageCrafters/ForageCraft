...
public class BabyFallowDeer<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "babyfallowdeer"), "main");
	...
	public BabyFallowDeer(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r6 = bb_main.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(20, 20).addBox(6.0F, -12.0F, -2.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		.texOffs(0, 0).addBox(-6.0F, -9.0F, -3.0F, 8.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
