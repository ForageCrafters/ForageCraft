...
package net.mcreator.foragecraft.world.inventory;
...
public class WickerBasketGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WickerBasketGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ForagecraftModMenus.WICKER_BASKET_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 17) {
			...
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("foragecraft:plants")));
			}
		}));
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 151, 17) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return ForagecraftModBlocks.FLY_AGARIC.get().asItem() == stack.getItem();
			}
		}));
