...
public class DehydratorUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DehydratorUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ForagecraftModMenus.DEHYDRATOR_UI.get(), id);
