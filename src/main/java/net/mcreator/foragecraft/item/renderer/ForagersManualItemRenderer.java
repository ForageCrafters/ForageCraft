package net.mcreator.foragecraft.item.renderer;
...
import net.mcreator.foragecraft.utils.AnimUtils;
import net.mcreator.foragecraft.item.model.ForagersManualItemModel;
import net.mcreator.foragecraft.item.ForagersManualItem;
import net.mcreator.foragecraft.interfaces.RendersPlayerArms;
...
public class ForagersManualItemRenderer extends GeoItemRenderer<ForagersManualItem> implements RendersPlayerArms {
	public ForagersManualItemRenderer() {
		super(new ForagersManualItemModel());
	}

	@Override
	public RenderType getRenderType(ForagersManualItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof ForagersManualItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new ForagersManualItemRenderer();
	...
	protected ForagersManualItem animatable;
	...
	@Override
	public void render(GeoModel model, ForagersManualItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(ForagersManualItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(ForagersManualItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(ForagersManualItem animatable) {
